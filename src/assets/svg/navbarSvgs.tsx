...
export const InterviewArrowSvg = () => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="16"
      ...
      fill="none"
    >
      <g clip-path="url(#clip0_1004_2623)">
        <path
